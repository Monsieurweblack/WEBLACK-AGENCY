...
function gateWith(claims: RegisteredClaim[], eligibleForAutoPublish: boolean) {
  return evaluateQualityGate({
    ...
    antiFabrication: { pass: true, unsupportedClaims: [], claims: [], byVerdict: { SUPPORTED_REFORMULATION: 0, SUPPORTED_TRANSLATION: 0, NORMALIZED_FACT: 0, LEGITIMATE_ANALYSIS: 0, UNSUPPORTED_DEDUCTION: 0, TRUE_FABRICATION: 0 } },
