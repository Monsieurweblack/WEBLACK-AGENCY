...
export const ui = {
  fr: {
    ...
    "seo.default.description":
      "WEBLACK est une agence créative indépendante qui relie talents, créativité, culture et opportunités au-delà des frontières. Talent management, direction créative et brand consulting.",
