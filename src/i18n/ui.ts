...
const translations = {
  fr: {
    ...
    "now.territory.FASHION_LUXURY": "Mode & luxe",
    "now.territory.ART_CULTURE": "Art & culture",
    "now.territory.DESIGN_ARCHITECTURE": "Design & architecture",
    "now.territory.CREATIVE_INDUSTRIES": "Industries créatives",
    "now.territory.TALENTS": "Talents",
    "now.territory.CULTURAL_CREATIVE_BUSINESS": "Business créatif",
    "now.territory.CULTURAL_SCENES_EVENTS": "Scènes culturelles",
    "now.territory.CULTURAL_AGENDA": "Agenda culturel",
    ...
    "agenda.hero.intro":
      "Expositions, défilés, biennales et foires en Afrique, dans ses diasporas et au-delà. Une sélection courte, vérifiée sur les pages officielles des organisateurs : ce qu'elles n'annoncent pas ne figure pas ici.",
    "agenda.seo.title": "Agenda — Les prochains rendez-vous de la création africaine et afro-diasporique",
    "agenda.seo.description":
      "Expositions, défilés, biennales et foires à venir, en Afrique, dans ses diasporas et à l'international — vérifiés sur les pages officielles des organisateurs.",
    "agenda.filter.all": "Tout",
    "agenda.filter.city": "Ville",
    "agenda.filter.country": "Pays",
    "agenda.filter.discipline": "Discipline",
    "agenda.filter.region": "Zone",
    "agenda.region.AFRICA": "Afrique",
    "agenda.region.AFRO_DIASPORA": "Diaspora",
    "agenda.region.INTERNATIONAL": "International",
    ...
    "live.status.PRELIVE": "Sur le point de commencer",
    "live.status.ON_AIR": "En direct",
    "live.status.ENDING": "Se termine",
    "live.status.REPLAY": "Replay",
    "live.status.ARCHIVED": "Archivé",
    "live.status.CANCELLED": "Annulé",
    "live.countdown.label": "Début dans",
    "live.countdown.day": "j",
    "live.countdown.hour": "h",
    "live.countdown.minute": "min",
    "live.countdown.second": "s",
    ...
    "live.cta.addToCalendar": "Ajouter à mon calendrier",
    "live.cta.share": "Voir la fiche",
    "live.archive.cta": "Voir les replays précédents",
    "live.archive.eyebrow": "Archive",
    "live.archive.title": "Les directs WEBLACK",
    "live.archive.empty": "Aucun replay disponible pour le moment.",
    "live.archive.filter.all": "Tout",
    "live.archive.filter.year": "Année",
    "live.archive.filter.discipline": "Discipline",
    "live.archive.filter.legend": "Filtrer l’archive",
    "live.archive.filter.reset": "Tout afficher",
  ...
  en: {
    ...
    "now.territory.FASHION_LUXURY": "Fashion & luxury",
    "now.territory.ART_CULTURE": "Art & culture",
    "now.territory.DESIGN_ARCHITECTURE": "Design & architecture",
    "now.territory.CREATIVE_INDUSTRIES": "Creative industries",
    "now.territory.TALENTS": "Talents",
    "now.territory.CULTURAL_CREATIVE_BUSINESS": "Creative business",
    "now.territory.CULTURAL_SCENES_EVENTS": "Cultural scenes",
    "now.territory.CULTURAL_AGENDA": "Cultural agenda",
    ...
    "agenda.hero.intro":
      "Exhibitions, runway shows, biennials and fairs across Africa, its diasporas and beyond. A short selection, verified against the organisers’ own pages: what they do not announce is not listed here.",
    "agenda.seo.title": "Agenda — Upcoming African and Afro-diasporic creative events",
    "agenda.seo.description":
      "Upcoming exhibitions, runway shows, biennials and fairs across Africa, its diasporas and internationally — verified against the organisers’ official pages.",
    "agenda.filter.all": "All",
    "agenda.filter.city": "City",
    "agenda.filter.country": "Country",
    "agenda.filter.discipline": "Discipline",
    "agenda.filter.region": "Region",
    "agenda.region.AFRICA": "Africa",
    "agenda.region.AFRO_DIASPORA": "Diaspora",
    "agenda.region.INTERNATIONAL": "International",
    ...
    "live.status.PRELIVE": "Starting soon",
    "live.status.ON_AIR": "Live now",
    "live.status.ENDING": "Ending soon",
    "live.status.REPLAY": "Replay",
    "live.status.ARCHIVED": "Archived",
    ...
    "live.cta.addToCalendar": "Add to calendar",
    "live.cta.share": "View page",
    "live.archive.cta": "See past replays",
    "live.archive.eyebrow": "Archive",
    "live.archive.title": "WEBLACK Live broadcasts",
    "live.archive.empty": "No replay available yet.",
    "live.archive.filter.all": "All",
    "live.archive.filter.year": "Year",
    "live.archive.filter.discipline": "Discipline",
    "live.archive.filter.legend": "Filter the archive",
    "live.archive.filter.reset": "Show all",
